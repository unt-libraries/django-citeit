...
class Location(models.Model):
    location = models.CharField(
        max_length=255,
        help_text="Locations should be in the format of <em>Country > State > County > Township</em>",
        )
...
class Citation(models.Model):
    ...
    pagination = models.IntegerField(
        help_text="Number of pages formatted as number <em>55</em> <br />Note: the pp is added by the system later ",
        )
